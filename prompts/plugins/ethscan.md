...
{
    "schema_version": "v1",
    "name_for_human": "ethscan user",
    "name_for_model": "ethscanner",
    "description_for_human": "plugin that makes requests from etherscan",
    "description_for_model": "plugin that makes requests from etherscan",
    "auth": {
        "type": "none"
    },
    "api": {
